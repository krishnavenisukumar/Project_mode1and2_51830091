...
public class BankappV1Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Account
		// account=accountRepository.findById(1L).orElseThrow(RuntimeException::new);
		...
		Customer customer3 = new Customer("karthick", "k@gmail.com", "5974545545", "banglore", "Karnataka", "india");
		...
		AppUser user3 = new AppUser("gunika", "gunika", "g@r.com", "54545455", "delhi", new String[] { "ROLE_CLERK" },
				true);

		AppUser user4 = new AppUser("keshav", "keshav", "k@r.com", "54545455", "delhi", new String[] { "ROLE_CLERK" },
				true);
